export default class CommonConfig {
    ...
    static generateUniqueCode = function () {
    ...
    static createUserName = function (username) {
        let finalName = username.toLowerCase().trim() + '@pentesthouse.com';
        return finalName;
    }
    ...
    static Razorpay = {
        // ApiKey: 'rzp_test_ec8FZGfd00juVU',
        ApiKey: 'rzp_live_cG4IzPVxrbTqdi',
        Name: 'PortLinksIndia Pvt. Ltd',
    }

    static Environment = {
        PROFILE_URL: '',
        API_KEY: "AIzaSyDkrAR0CKDqCogtUVLxZP2a2H__jLmhDqY"
    }
